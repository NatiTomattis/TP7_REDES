...
VOLUME1=~/Documents/REDES/redes-quagga/volumes/quagga1
VOLUME254=~/Documents/REDES/redes-quagga/volumes/quagga254
...
sudo docker run --name quagga1 --privileged -d -v $VOLUME1:/etc/quagga quagga2
#quagga254 instantiation
sudo docker run --name quagga254 --privileged -d -v $VOLUME254:/etc/quagga quagga2
